...
class Car:
    ...
    def __init__(self):
        ...
        self.position = [670, 688] # Starting Position
        self.angle = 0
        self.speed = 0

        self.initial_speed = False 
    ...
    def draw(self, screen):
        ...
        self.draw_radar(screen) #OPTIONAL 
    ...
    def update(self, game_map):
        ...
        self.position[0] = max(self.position[0], 25)
        ...
        self.position[1] = max(self.position[1], 25)
